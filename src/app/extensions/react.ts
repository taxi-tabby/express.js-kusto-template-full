...
// head 에는 Home 페이지의 웹폰트만 추가한다 — Fraunces(디스플레이) · IBM Plex Sans KR(한글
// 본문) · JetBrains Mono(기술 라벨/코드).
export default react({
    head: [
        `<link rel="preconnect" href="https://fonts.googleapis.com">`,
        `<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>`,
        `<link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Fraunces:ital,opsz,wght@0,9..144,500;0,9..144,600;1,9..144,500;1,9..144,600&family=IBM+Plex+Sans+KR:wght@300;400;500;600;700&family=JetBrains+Mono:wght@400;500;600&display=swap">`,
    ].join('\n'),
});
